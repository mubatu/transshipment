...
\begin{titlepage}
    ...
    \begin{large}
    \begin{tabular}{rl}
        Student ID: & 2021400231 \\
        Student Name: & Mustafa Batuhan Büber \\
    \end{tabular}
    \end{large}
...
% ================== QUESTION 1 ==================
\section*{Question 1: Modeling}
\addcontentsline{toc}{section}{Question 1: Modeling}
...
\addcontentsline{toc}{section}{Question 2: Implementation}
...
% ================== QUESTION 3 ==================
\section*{Question 3: Economic Interpretation and Sensitivity Analysis}
\addcontentsline{toc}{section}{Question 3: Economic Interpretation and Sensitivity Analysis}
...
% ================== QUESTION 4 ==================
\section*{Question 4: Integrality}
\addcontentsline{toc}{section}{Question 4: Integrality}
